    ...
    $.fn.QSwipe = function(options,callback){
        ...
        function _addEvtHandler(){
            ...
            function moveTransition(event){
                ...
                switch (effect){
                    ...
                    case "fade":(function(event){
                        ...
                        moveWithFadeEffect(_isV,currentVal,event);
                    ...
                    case "ease":(function(event){
                        ...
                        moveWithEaseEffect(_isV,currentVal,event);
            ...
            function moveWithNormalEffect(isV,current,event){
                ...
                console.dir("||"+curTransformVal+"||cur="+sibTransformVal);
            ...
            function moveWithFadeEffect(_isV,currentVal,event){
                moveWithNormalEffect(_isV,currentVal,event);
                _siblingElement.css({
                    'opacity' : '0.3'
                });
            ...
            function moveWithEaseEffect(_isV,currentVal,event){
                console.dir("current="+currentVal);
                moveWithNormalEffect(_isV,currentVal*0.2,event);
                var totalRange=Math.abs(_positions.current)/_isV?_height:_width;
                _curElement.css({
                    'z-index':"999"
                });
            }
